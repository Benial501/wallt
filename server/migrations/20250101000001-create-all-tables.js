...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.createTable('users', {
      ...
      tema: { type: Sequelize.ENUM('dark', 'light'), defaultValue: 'dark' },
    ...
    await queryInterface.createTable('profili_utente', {
      ...
      paga_bollette: { type: Sequelize.ENUM('tutte', 'divise', 'no'), defaultValue: 'no' },
    ...
    await queryInterface.createTable('movimenti', {
      ...
      tipo: { type: Sequelize.ENUM('entrata', 'uscita', 'trasferimento'), allowNull: false },
      ...
      ricorrente_frequenza: { type: Sequelize.ENUM('giornaliera', 'settimanale', 'mensile', 'annuale'), allowNull: true },
    ...
    await queryInterface.createTable('movimenti_scommesse', {
      ...
      user_id: { type: Sequelize.INTEGER, allowNull: false },
      tipo: { type: Sequelize.ENUM('deposito', 'prelievo', 'vincita', 'perdita'), allowNull: false },
      importo: { type: Sequelize.DECIMAL(12, 2), allowNull: false },
      data: { type: Sequelize.DATEONLY, allowNull: false },
      nota: { type: Sequelize.STRING(500), allowNull: true },
      created_at: { type: Sequelize.DATE, allowNull: false },
    ...
    await queryInterface.createTable('investimenti', {
      ...
      tipo: { type: Sequelize.ENUM('azioni', 'etf', 'crypto', 'fondi', 'obbligazioni', 'altro'), allowNull: false, defaultValue: 'azioni' },
    ...
    await queryInterface.createTable('movimenti_investimento', {
      ...
      user_id: { type: Sequelize.INTEGER, allowNull: false },
      tipo: { type: Sequelize.ENUM('versamento', 'prelievo', 'rendimento', 'perdita'), allowNull: false },
      importo: { type: Sequelize.DECIMAL(12, 2), allowNull: false },
      data: { type: Sequelize.DATEONLY, allowNull: false },
